...
/// @notice Deploy full Asset + BLS12381 verifier on Sepolia Testnet (chainId=11155111).
///
/// Prerequisites:
///   - Deployer wallet has Sepolia ETH (faucet: https://sepoliafaucet.com)
///   - forge installed
///
/// Usage:
///   export PRIVATE_KEY=<your_deployer_privkey_hex>
///   FOUNDRY_PROFILE=deploy forge script script/DeploySepoliaTestnet.s.sol:DeploySepoliaTestnetScript \
///     --rpc-url https://rpc.sepolia.org \
///     --broadcast -vvv
///
/// After deployment, fill printed addresses into relayer config/local.yaml:
///   ChainInfos[0].ChainID: 11155111
///   ChainInfos[0].Url: https://rpc.sepolia.org
///   ChainInfos[0].PoolContractAddress: <Asset proxy addr>
///   DeployAddress: <deployer addr>
///   DeployerPrivateKey: <PRIVATE_KEY>
contract DeploySepoliaTestnetScript is Script {
    ...
    function run() external {
        ...
        // 2. Deploy BLS12381 verifier (uses EIP-2537 precompile)
        ...
        console.log("ChainInfos[0].ChainID: 11155111");
        console.log("ChainInfos[0].Url: https://rpc.sepolia.org");
