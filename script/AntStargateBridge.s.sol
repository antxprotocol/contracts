...
contract AntStargateBridgeScript is Script {
    ...
    function run() external {
        ...
        (uint256 valueToSend, SendParam memory sendParam, MessagingFee memory messagingFee) = arbSepoliaAdapter.prepareTakeTaxi(destinationEndpointId, tokensToSend, receiver);
