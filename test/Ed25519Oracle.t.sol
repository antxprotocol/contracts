...
contract Ed25519OracleTest is Test {
    ...
    bytes public constant TEST_SIGNATURE =
        hex"1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef";
    ...
    function setUp() public {
        ...
        // Deploy oracle
        oracle = new Ed25519Oracle(MINIMUM_STAKE, CONSENSUS_THRESHOLD, CONSENSUS_TIMEOUT, MAX_DATA_AGE);
    ...
    function testRegisterNode() public {
        ...
        (bool isActive, uint256 stake, uint256 reputation, uint256 lastActivity, bool isRegistered) =
            oracle.getNodeInfo(node1);
    ...
    function testUnregisterNodeRemovesTail() public {
        ...
        assertTrue(
            (afterNodes[0] == owner && afterNodes[1] == node1) || (afterNodes[0] == node1 && afterNodes[1] == owner)
        );
    }
    ...
    function testSubmitProof() public {
        ...
        (uint256 validVotes, uint256 invalidVotes, uint256 totalVotes, bool isFinalized, bool finalResult,,) =
            oracle.getConsensusData(dataId);
